...
Your Instructor will give you the Digital Assistant Cloud host name to use
(if you are using the local Virtual Machine image use *"localhost"* as the hostname)

Navigate to the [Development]->[Skills] tab from the menu.

2. Create a new Skill Bot called ``"Cafe_Supremo_TD_[YOUR INITIALS]"`` 
...
8. Click the "Try It Out!" Link to launch the Intent Tester
